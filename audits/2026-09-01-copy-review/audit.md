...
검토 당시 화면과 문서에서 발견한 어색한 혼용 표현과 내부 구현 용어를 수정했습니다. 개발자용 Studio는 영어, 한국어 소비 앱 예시는 한국어로 통일했습니다. 코드 식별자와 표준 이름은 그대로 유지했습니다.
...
이 보고서는 2026-09-01에 확인한 화면과 문서에 한정됩니다. 이후 변경한 문구는 새 검토 대상으로 관리합니다.
