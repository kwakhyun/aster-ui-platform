...
- 생성 기준: 2026. 09. 02. 18:36 KST
- 소스 리비전: `workspace:ddfb2c4cd12b35d19862`
- Git 커밋: `86a3acbff8b4684ad080e5f470981fb8c9deb135`
...
| AI 제안 및 승인 E2E | 제안 검사 6개, 검증 실패 시 중단하는 경계 7개, AI 제공자 호출 제한 시간과 출력 상한 적용, 검증 단계의 소스 수정 없음 |
...
| Studio | 93.39% | 90.22% | 92.56% | 96.19% |

## 성능 예산

| 자산 | 실제 크기 | 예산 |
| --- | ---: | ---: |
| JavaScript gzip | 92,722 B | 190,000 B |
