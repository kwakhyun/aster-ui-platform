...
- 생성 기준: 2026. 09. 05. 17:47 KST
- 소스 리비전: `workspace:2d483ca0848ebe9a875e`
- 소스 기준 커밋: `e696468b2d7e3ce217fba27f207a509ff2c2441a`
...
| 자산 | 실제 크기 | 예산 |
| --- | ---: | ---: |
| JavaScript gzip | 96,927 B | 190,000 B |
...
| 지표 | 측정 | 예산 |
| --- | ---: | ---: |
| FCP 중앙값 | 520 ms | 3000 ms |
| LCP 중앙값 | 520 ms | 4000 ms |
| CLS 최댓값 | 0.000 | 0.1 |
